...
#define CUSTOM_MACHINE_NAME "Prusa i3 A602"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "7defa4bb-a963-40df-853d-e4b0f6c37fb9"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //Auto-Tune with E3Dv6 clone 2015-12-12
  #define  DEFAULT_Kp 12.60
  #define  DEFAULT_Ki 0.68
  #define  DEFAULT_Kd 58.52
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Auto-Tune 2015-12-12
  #define  DEFAULT_bedKp 234.97
  #define  DEFAULT_bedKi 45.96
  #define  DEFAULT_bedKd 300.29
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 98.7f, 98.7f, 400.0f, 96.0f }
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75  //Enter the diameter (in mm) of the filament generally used (3.0 mm or 1.75 mm) - this is then used in the slicer software.  Used for sensor reading validation
  ...
  #define MEASURED_UPPER_LIMIT         1.95  //upper limit factor used for sensor reading validation in mm
  #define MEASURED_LOWER_LIMIT         1.55  //lower limit factor for sensor reading validation in mm
